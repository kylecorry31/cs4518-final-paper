...
SOUPS 2013 conference paper in either LaTeX or Microsoft Word Format.

The SOUPS 2013 conference format is the ACM SIG Proceedings Template
...
If you use LaTeX to create your paper, SOUPS 2013 recommends that you
use pdflatex directly. 

SOUPS 2013 specifically recommends against using latex to create a DVI
...
2013 papers. There are just two significant areas where pdflatex is
